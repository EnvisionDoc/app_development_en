...
project = u'EnOS Application Development'
...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS Application Development} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{Application Development}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS Application Development',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Application Development',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Application Development',
